...
class MIMEText extends MIME
{
    public const VND_IN3D_3DML = 'text/vnd.in3d.3dml';
    public const X_ASM = 'text/x-asm';
    public const X_C = 'text/x-c';
    public const PLAIN = 'text/plain';
    public const MARKDOWN = 'text/markdown';
    public const X_MARKDOWN = 'text/x-markdown';
    public const CSS = 'text/css';
    public const CSV = 'text/csv';
    public const VND_CURL = 'text/vnd.curl';
    public const VND_CURL_DCURL = 'text/vnd.curl.dcurl';
    public const PRS_LINES_TAG = 'text/prs.lines.tag';
    public const X_SETEXT = 'text/x-setext';
    public const X_FORTRAN = 'text/x-fortran';
    ...
    public const X_JAVA_SOURCE = 'text/x-java-source';
    public const JAVASCRIPT = 'text/javascript';
    public const TROFF = 'text/troff';
    public const MATHML = 'text/mathml';
    public const VND_CURL_MCURL = 'text/vnd.curl.mcurl';
    public const X_PASCAL = 'text/x-pascal';
    public const X_PYTHON = 'text/x-python';
    public const RICHTEXT = 'text/richtext';
    public const VND_CURL_SCURL = 'text/vnd.curl.scurl';
    ...
    public const X_UUENCODE = 'text/x-uuencode';
    public const X_VCARD = 'text/x-vcard';
    public const X_VCALENDAR = 'text/x-vcalendar';
